...
> = runtime.Types.Extensions.GetOmit<
  'id' | 'problemId' | 'input' | 'expected' | 'isHidden' | 'order' | 'createdAt' | 'updatedAt',
  ExtArgs['result']['testCase']
>;
...
export type TestCaseGetPayload<S extends boolean | null | undefined | TestCaseDefaultArgs> =
...
> {
  ...
  >(
    args: Prisma.SubsetIntersection<T, TestCaseGroupByArgs, OrderByArg> & InputErrors,
  ): {} extends InputErrors ? GetTestCaseGroupByPayload<T> : Prisma.PrismaPromise<InputErrors>;
  /**
